...
# Reset all save data to default values
func reset_save_data():
	# Reset to default values
	game_data = {
		"total_coins": 0,
		"unlocked_cars": {
			"car1": true,  # Only the first car is unlocked
			"car2": false,
			"car3": false,
			"car4": false,
			"car5": false,
	...
	# Reset the current game coins
	current_game_coins = 0
	
	print("SaveManager: Game data reset to default values")
