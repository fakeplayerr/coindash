...
# # Scenes
# @onready var road_segment_scene = preload("res://src/road_segment.tscn")
# @onready var human_scene = preload("res://src/human.tscn")
# @onready var powerup_scene = preload("res://src/power_up.tscn")
